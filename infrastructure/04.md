...
2. In the search bar, type **IoT**, then select **IoT Hub** from the search results.
    ...
    ![The IoT Hub search result is selected.](media/IOT%20hub.png "Search IoT")
...
4. Select **IoT devices** in the left-hand menu, then select **+Add Device** in the IoT devices blade.
    ...
    ![The IoT devices menu item is highlighted, as well as the New button on its blade.](media/ex4tsk1stp4.png "IoT devices")
...
2. In the search menu, type **stream**, then select **Stream Analytics jobs**.
    ...
    ![Stream is highlighted in the search box, and the Stream Analytics jobs item in the results is highlighted.](media/stream.png "Stream search")
