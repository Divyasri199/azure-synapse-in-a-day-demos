...
2. In the search menu, type **Synapse**, then select **Azure Synapse Analytics**.
    ...
    ![Synapse is highlighted in the search box, and the Azure Synapse Analytics workspace preview item in the results is highlighted.](media/synpase-anal.png "Synapse search")

3. Select the Synapse Workspace that you created for this lab, or that was provided for you in the lab environment.

     ![](media/selectsynapse.png)
