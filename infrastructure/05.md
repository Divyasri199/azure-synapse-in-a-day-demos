...
11. Click an empty location in the report area. Click **Format** (Paint brush), and then click **Page refresh off** to turn it on. Set the duration to **1 minute**.

    ![Auto-refresh is turned on.](media/pbi-refresh-up.png "Refresh")
