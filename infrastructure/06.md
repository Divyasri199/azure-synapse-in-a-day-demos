...
2. Enter each setting as shown in the table below, then select **Next: Additional settings**.

    ![The form is configured as described.](media/spark1.png "Create Apache Spark pool")
    ...
    | Number of nodes | 3-10 | Default settings |

    > **Note**: If **Estimated Price** displays **Failed to parse billing response**, Please **Ignore** it and proceed with the next steps.

3. On the Additional settings page select Apache Spark version as **2.4**, then select **Review + create**.

   ![The form is configured as described.](media/spark2.png "Create Apache Spark pool")

4. Review the settings, then select **Create**.

    ![The create button is highlighted.](media/spark3.png "Create")
